...
{
    public interface IReservedCapacityMetrics
    {
#pragma warning disable SA1611
        /// <summary>
        /// Records an increase in the amount of reserved capacity against the meter in the subscription for the resource id
        ...
        /// </remarks>
        void Increase(Guid subscriptionId, Guid resourceId, DateTimeOffset dateTime, string meter, int amount, string reason = null);

        /// <summary>
        /// Records a decrease in the amount of reserved capacity against the meter in the subscription for the resource id
        /// (and optionally give a free text reason).
        /// </summary>
        /// <remarks>
        /// When a subscription user has consumed resources (e.g. sent an SMS or performed a backup),
        /// we call this method to record what was "consumed".
        /// </remarks>
        void Decrease(Guid subscriptionId, Guid resourceId, DateTimeOffset dateTime, string meter, int amount, string reason = null);
        ...
        IReservedCapacityMetrics ForInternalContext(string name, string value);

        /// <summary>
        /// Adds arbitrary property names and values (context) to the metrics record. Use this method
        ...
        /// </remarks>
        /// <returns>An instance with the additional context values included.</returns>
        IReservedCapacityMetrics ForSubscriptionOwnerContext(string name, string value);
